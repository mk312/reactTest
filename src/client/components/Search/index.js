...
import {
  updateSearchWord, updateFilter, requestMoviesArr, updateMoviesPage,
} from '../../actions/actions';
import Toggle from '../basic/Toggle';
import './search_bg.jpg';
    ...
    return (
      <form className={`js-search-form ${styles.wrapper}`} onSubmit={this.handleSubmit}>
        <div className={'row'}>
          ...
          <input className={`js-search-input ${styles.input}`}
            type="text"
            value={this.props.searchParams.searchWord}
